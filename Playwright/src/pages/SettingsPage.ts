...
import { PatientSearchHelper } from "src/tests/reusableMethod";
...
export class SettingsPage {
   ...
   */
    async addAndVerifyNewImagingType() {
        ...
        await PatientSearchHelper.highlightElement(this.settingsLink);
        await this.settingsLink.click();

        await PatientSearchHelper.highlightElement(this.radiologySubmodule);
        await this.radiologySubmodule.click();
        await this.page.waitForTimeout(2000);

        // Click on Add Imaging Type button to open the modal
        await PatientSearchHelper.highlightElement(this.addImagingTypeButton);
        ...
        await PatientSearchHelper.highlightElement(this.imagingItemNameField);
